...
public class SolicitacaoController {
	...
	@PostMapping("/solicitacao/autorizar")
	...
	@PostMapping("/solicitacao/negar")
	public ResponseEntity<Solicitacao> negarSolic(@RequestBody Solicitacao solic){
		try{
			Solicitacao retorno = solicdao.save(solic);
			return ResponseEntity.ok(retorno);
		}catch(Exception e) {
	...
	@PostMapping("/solicitacao/cancelar")
	public ResponseEntity<Solicitacao> cancelarSolic(@RequestBody Solicitacao solic){
		try{
			Solicitacao retorno = solicdao.save(solic);
			return ResponseEntity.ok(retorno);
		}catch(Exception e) {
